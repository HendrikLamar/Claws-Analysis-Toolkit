...
def __searchByIndexFile_helper__(dType,x,fRunN,fSubRunN,lRunN,lSubRunN):
...
def findByIndexFile(firstEvent, lastEvent, dType="online"):
    '''
...
def getPandasDF( firstEvent, lastEvent, onePerRunNumber=False):
    '''
    ...
    counter = 0
    lrunNumber = []
    files = findByIndexFile(firstEvent,lastEvent)
